...
// Setting the server to use the different libraries
server.use(morgan("short"));
server.use(parser.urlencoded({ extended: false }));
server.use(express.static("./src/public/components/"));
server.use(
  session({
...
server.post("/userdetails", (req, res) => {
  let object = {
...
//Printing a message to the console to show on which port the server is running
