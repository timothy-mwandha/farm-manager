            ...
            <KeyboardAvoidingView style={styles.container} behavior="padding" enabled >
                <ScrollView>
                    <View>
                        ...
                        <View style={styles.butt}><Button color="#0A802B" title="Sign Up" onPress={this.handleSubmit} /></View>
                        <Text style={styles.question}>Have an account?</Text>
                        <Text style={styles.link} onPress={() => Linking.openURL('http://google.com')}>Log In</Text>
                    </View>
                </ScrollView>
